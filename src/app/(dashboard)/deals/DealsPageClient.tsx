...
import { KanbanBoard, DealForm, PipelineStats, PipelineStatsCompact } from '@/components/deals';
...
export function DealsPageClient({ initialDealsByStage, initialStats }: DealsPageClientProps) {
