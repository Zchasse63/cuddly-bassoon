/**
 * @deprecated DEPRECATED: Leads API Routes
 ...
 *
 * Please migrate to:
 * - GET /api/deals - List pipeline items with filters
 * - POST /api/deals - Create a new pipeline item
 *
...
/**
 * @deprecated Use GET /api/deals instead
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const validation = leadListFiltersSchema.safeParse({
...
/**
 * @deprecated Use POST /api/deals instead
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const service = new LeadService(supabase);
    const lead = await service.createLead(user.id, validation.data);
