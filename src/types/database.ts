...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      market_data: {
        Row: {
          ...
          census_data_quality: string | null;
          ...
          moved_different_state: number | null;
          negative_momentum_score: number | null;
          outmigration_rate: number | null;
          ...
          rentcast_data_quality: string | null;
          rentcast_last_updated: string | null;
          renter_occupied_units: number | null;
          renter_percentage: number | null;
          same_house_1yr_ago: number | null;
          scores_last_calculated: string | null;
          senior_percentage: number | null;
          senior_population: number | null;
          state: string | null;
    ...
    Views: {
      loss_pipeline_analytics: {
        Row: {
          avg_days_in_pipeline: number | null;
          avg_our_offer: number | null;
          avg_price_delta: number | null;
          avg_winning_price: number | null;
          deals_lost: number | null;
          lost_competing_offer: number | null;
          lost_contact: number | null;
          lost_financing: number | null;
          lost_inspection: number | null;
          lost_price_too_high: number | null;
          lost_price_too_low: number | null;
          lost_seller_changed_mind: number | null;
          lost_timing: number | null;
          month: string | null;
          pipeline_sales: number | null;
          sold_to_flippers: number | null;
          sold_to_investors: number | null;
          sold_to_owner_occupants: number | null;
          sold_to_wholesalers: number | null;
          total_sales_tracked: number | null;
          user_id: string | null;
        };
        Relationships: [];
      };
    ...
    Functions: {
      ...
      mark_property_sold: {
        Args: {
          p_buyer_name?: string;
          p_buyer_type?: string;
          p_competitor_who_won?: string;
          p_lost_reason?: string;
          p_lost_reason_details?: string;
          p_our_offer_amount?: number;
